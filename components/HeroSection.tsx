    ...
    >
      ...
      <div className="absolute inset-0 z-10 flex flex-col justify-center items-center text-center p-6">
          <div className="w-full relative flex flex-col items-center">
            ...
            <p 
              className={`text-sm md:text-xl text-white/70 max-w-sm md:max-w-2xl mx-auto my-8 md:my-8 transition-all duration-700 ease-out font-light leading-relaxed ${animateText ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
            ...
            >
              ...
              <a href="#" onClick={handleOpenImagineModal} className="w-full sm:w-auto bg-white/5 backdrop-blur-xl border border-white/10 text-white px-8 py-5 rounded-2xl font-black text-[11px] uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all active:scale-95 flex items-center justify-center gap-3 hover:shadow-lg hover:shadow-white/20">
